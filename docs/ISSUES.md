...
| [ ] | - | F17-1 | 과거 달의 AI 분석 결과 뷰 연동 | `feat/historical-ai-analysis-ui` | - | Page·Hook | `['aiInsights']` | 신규 | 상단 날짜(globalDate) 변경 시 useAiInsightsQuery 등 훅에 month 파라미터를 넘겨 과거 데이터를 패칭하고 UI 업데이트 |
