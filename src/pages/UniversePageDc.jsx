    ...
    <>
      ...
      <Container ref={containerRef} style={isMobile ? { height: 'calc(100dvh - 150px)', padding: '0', borderRadius: 0, boxShadow: 'none', overflow: 'hidden' } : {}}>
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 3, transition: "transform .6s cubic-bezier(.4,0,.2,1)", transform: phase === "flying" ? `scale(2.5) ${selected === "current" ? "translate(10%, 20%)" : "translate(-30%, 15%)"}` : phase === "result" ? "scale(0) opacity(0)" : "scale(1)" }}>
          ...
          {isMobile && <div style={{ position: "absolute", left: "50%", top: 165, transform: "translateX(-50%) rotate(-8deg)", width: "82%", height: 110, border: "1px solid rgba(255,255,255,0.25)", borderRadius: "50%", pointerEvents: "none", zIndex: 3 }}></div>}

          <div onClick={() => select("current")} style={{ position: "absolute", left: isMobile ? "22%" : 330, top: isMobile ? 175 : 196, transform: "translate(-50%,-50%)", cursor: "pointer", zIndex: 4 }}>
            <div style={{ position: "relative", width: isMobile ? 100 : 150, height: isMobile ? 100 : 150 }}>
              <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", width: isMobile ? 150 : 232, height: isMobile ? 150 : 232, borderRadius: "50%", background: "radial-gradient(circle,rgba(158,150,238,.5),transparent 60%)", filter: "blur(16px)", animation: "pu-glow 4.4s ease-in-out infinite" }}></div>
              <UniversePlanet tone="stress" size={isMobile ? 100 : 150} />
          ...
          <div onClick={() => select("reduced")} style={{ position: "absolute", left: isMobile ? "78%" : 830, top: isMobile ? 260 : 196, transform: "translate(-50%,-50%)", cursor: "pointer", zIndex: 4 }}>
            <div style={{ position: "relative", width: isMobile ? 100 : 150, height: isMobile ? 100 : 150 }}>
              <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", width: isMobile ? 150 : 232, height: isMobile ? 150 : 232, borderRadius: "50%", background: "radial-gradient(circle,rgba(130,226,194,.5),transparent 60%)", filter: "blur(16px)", animation: "pu-glow 4s ease-in-out .6s infinite" }}></div>
              <UniversePlanet tone="calm" size={isMobile ? 100 : 150} />
              {selected === "reduced" && <div style={{ position: "absolute", left: "50%", top: "50%", width: isMobile ? 140 : 222, height: isMobile ? 140 : 222, borderRadius: "50%", background: "radial-gradient(circle,rgba(130,226,194,.6),transparent 62%)", filter: "blur(14px)", animation: "pu-selglow 1.7s ease-in-out infinite" }}></div>}
        ...
        <div style={{ position: "absolute", left: 0, right: 0, bottom: isMobile ? 8 : 0, height: "auto", aspectRatio: isMobile ? "auto" : "1160 / 300", zIndex: 5, transform: parked ? "translateY(48px)" : "none", opacity: parked ? 0 : 1, pointerEvents: parked ? "none" : "auto", transition: "opacity .5s ease, transform .6s cubic-bezier(.5,.05,.2,1)" }}>
          <div style={{ width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "flex-end" }}>
            <div style={{ width: isMobile ? "100%" : 1160, height: "auto", aspectRatio: isMobile ? "auto" : "1160/300" }}>
              <UniverseConsole 
                isMobile={isMobile}
